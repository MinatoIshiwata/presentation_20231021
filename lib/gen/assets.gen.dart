...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/eye_off.svg
  SvgGenImage get eyeOff => const SvgGenImage('assets/images/eye_off.svg');

  /// File path: assets/images/leading_button.svg
  SvgGenImage get leadingButton =>
      const SvgGenImage('assets/images/leading_button.svg');

  /// List of all assets
  List<SvgGenImage> get values => [eye, eyeOff, leadingButton];
}
