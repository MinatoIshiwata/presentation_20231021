...
import 'package:presentation_20231021/screens/sign_in_screen.dart';
import 'package:presentation_20231021/screens/top_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ScreenUtilInit(
        designSize: const Size(375, 812), // 開発基準サイズ Fimgaのサイズとしています
        builder: (context, _) {
          return MaterialApp(
            title: 'Flutter Demo',
